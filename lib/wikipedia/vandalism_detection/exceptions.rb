module Wikipedia
  module VandalismDetection
    ...
    # @abstract Exceptions raised by Wikipedia::VandalismDetection inherit from this Error
    class Error < StandardError; end

    # Exception is raised when trying to classify without a configured classifier
    ...
    # Exception is raised when trying to use features without having configured some
    class FeaturesNotConfiguredError < Error; end

    # Exception is raised when trying to use edits file without having configured some
    class EditsFileNotConfiguredError < Error; end

    # Exception is raised when trying to use annotations file without having configured some
