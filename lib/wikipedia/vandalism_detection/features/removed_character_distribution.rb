...
module Wikipedia
  module VandalismDetection
    module Features
      ...
      # This feature computes the Kullback-Leibler Divergence of the removed text's character distribution
      # relative to the character distribution of the new revision's text.
