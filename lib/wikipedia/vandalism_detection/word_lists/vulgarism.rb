  ...
  module VandalismDetection
    module WordLists
      ...
      VULGARISM =
          ...
          :"f.u.c.k", :"f-u-c-k", :dyke, :douchebag, :douche, :douch3, :doosh, :dildo, :dike,
          ...
          :knobend, :labia, :lmfao, :moolie, :muff, :nigga, :nigger, :"p.u.s.s.y.", :penis,
          :piss, :"piss-off", :pissoff, :prick, :pube, :pussy, :queer, :retard, :retarded,
          :"s-h-1-t", :"s-h-i-t", :"s.h.i.t.", :scrotum, :sex, :sh1t, :shit, :slut, :smegma, :t1t, :tard,
          :terd, :tit, :tits, :titties, :turd, :twat, :vag, :vagina, :wank, :wetback, :whore,
          ...
          :d1ck, :dickhead, :dickheads, :"doggie-style", :dildos, :douchebags, :dumass, :dumbass,
          ...
          :boozy, :bosom, :bosomy, :bowel, :bowels, :bra, :brassiere, :breast, :breasts, :bung, :babe,
          ...
          :nappy, :nazism, :negro, :niggle, :nimrod, :ninny, :nipple, :nooky, :nympho, :opiate, :opium,
          ...
          :puss, :queef, :quicky, :racist, :racy, :raped, :raper, :rapist, :raunch, :rectal, :rectum,
          :rectus, :reefer, :reich, :revue, :risque, :rum, :rump, :sadism, :sadist, :satan, :scag,
